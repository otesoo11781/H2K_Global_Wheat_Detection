...
from efficientdet.dataset import Resizer, Normalizer, Augmenter, collater, CSVDataset
...
def get_args():
    ...
    parser.add_argument('-p', '--project', type=str, default='global_wheat_detection', help='project file that contains parameters')
